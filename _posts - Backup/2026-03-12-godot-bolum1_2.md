...
Godot'ya adım attığınızda karşınıza çıkan ilk sorulardan biri şu olur: **"Hangi dili öğrenmeliyim?"** Bu yazıda Godot'da kullanabileceğiniz dillere kısaca değinecek ve özellikle yeni başlayanlar için neden GDScript'in doğru seçim olduğunu açıklayacağız.

---

## Godot'da Hangi Dillerle Kod Yazılır?

Godot'da iki ana programlama diliyle oyun yazabilirsiniz:
...
C# daha büyük ve karmaşık projelerde, ya da daha önce Unity gibi bir motorda C# kullandıysanız iyi bir seçim olabilir. Ayrıca performans odaklı kritik sistemler yazacaksanız da C# avantaj sağlayabilir.
...
Bu eğitim serisinde biz **GDScript** kullanacağız. Zaten biraz programlama geçmişiniz varsa işiniz çok daha kolay olacaktır. GDScript'i pratikte öğrenmek için en iyi yol, bir şeyler yapmaya başlamaktır.
